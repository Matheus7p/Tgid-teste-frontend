  ...
  return(
    <div className="flex flex-col lg:flex-row justify-between gap-6 items-center mx-4 lg:mx-60" data-aos="fade-up">
      {_CLOCK.map((clock, index) => (
        <div key={index} className="flex flex-col max-w-80 lg:max-w-96 lg:h-[575px] gap-10 items-center lg:gap-2 rounded-lg bg-zinc-300/50 shadow-2xl p-4 backdrop-blur">
